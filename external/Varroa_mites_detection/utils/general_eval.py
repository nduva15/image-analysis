...
def save_validation_results(images, detections, counter, out_dir, classes, colors, detection_threshold=0.3):
    """
    ...
    for i, detection in enumerate(detections):
        ...
        boxes = bboxes[scores >= detection_threshold].astype(np.int32)
