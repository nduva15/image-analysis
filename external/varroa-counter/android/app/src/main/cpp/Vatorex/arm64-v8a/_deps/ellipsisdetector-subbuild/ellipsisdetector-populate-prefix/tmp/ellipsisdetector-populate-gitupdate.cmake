...
execute_process(
  COMMAND "/usr/bin/git" show-ref "fit_based_version"
  WORKING_DIRECTORY "/Users/joaquinblanco/Developer/FlutterProjects/varroa_counter_zhaw/ZHAW/Vatorex/dependencies/EllipsisDetector"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "fit_based_version")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("fit_based_version" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/fit_based_version")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/joaquinblanco/Developer/FlutterProjects/varroa_counter_zhaw/ZHAW/Vatorex/dependencies/EllipsisDetector'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/joaquinblanco/Developer/FlutterProjects/varroa_counter_zhaw/ZHAW/Vatorex/dependencies/EllipsisDetector'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
