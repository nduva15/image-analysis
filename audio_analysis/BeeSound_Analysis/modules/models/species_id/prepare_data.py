...
def save_data(
    ...
    """
    Preload the audio files and save them to disk.

    Args:
        X_train:
            Pandas dataframe that contains the training audio paths and labels.

        X_val:
            Pandas dataframe that contains the validation audio paths and labels.

        X_test:
            Pandas dataframe that contains the testing audio paths and labels.

        train_path:
            Path to save the preloaded training dataset.

        val_path:
            Path to save the preloaded validation dataset.

        test_path:
            Path to save the preloaded testing dataset.
